...
insert into flowers (variety, colour, plu, farm_id, barcode, mix, sticker_text, lenght, bucket_size, sleeve_type, fob, price_pr_bunch, fairtrade, bunch_pr_box, bunch_pr_bucket, stems_pr_bunch, pak_rate)
values ('mirabel', 'red', '123123', '1', '121212333333', '0', 'mirabel' , '40', '15', 'sleeve 1', '2.1', '1.23', '1', '30','4', '15', '320') ;  

insert into flowers (variety, colour, plu, farm_id, barcode, mix, sticker_text, lenght, bucket_size, sleeve_type, fob, price_pr_bunch, fairtrade, bunch_pr_box, bunch_pr_bucket, stems_pr_bunch, pake_rate)
